//--constante "itens" qual recebe e organiza os itens dentro de um dicionario(estrutura) json.
const itens = [
  {
...
//--professor nao consegui implementar o dataset na:atividade 10-->
//--importa e organiza itens do arquivo json dataset para melhor pratica 
import itens from "X:\projetos\HTML\p2\script\LIS-main\CafeAppLis\js\dataset.js" ; 
//--algoritiom modularizado qual recebe(guarda) e insere(exporta) os itens ao roll de itens que constam no cardapio.html.  
